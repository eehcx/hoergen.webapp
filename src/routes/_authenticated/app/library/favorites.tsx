...
export const Route = createFileRoute('/_authenticated/app/library/favorites')({
    ...
    <div className="container space-y-6 p-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          The stations you love most, always at hand
        </p>
      </div>
        ...
        <Card className="text-center py-12">
          <CardContent>
            ...
            <p className="text-muted-foreground mb-4">
              Explore stations and mark the ones you like most as favorites
            </p>
            <Button>Explore stations</Button>
          </CardContent>
        </Card>
      )}
    </div>
