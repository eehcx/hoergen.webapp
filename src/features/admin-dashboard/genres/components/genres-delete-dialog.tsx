...
export function GenresDeleteDialog({ open, onOpenChange, currentRow }: Props) {
  ...
  const handleDelete = async () => {
    ...
    try {
      await GenreService.getInstance().deleteGenre(currentRow.id)
      ...
      desc={
        <div className='space-y-4'>
          <p className='mb-2'>
            ...
            <br />
            This action will permanently remove the genre and all its associated data.
          </p>
          <div className=''>
