      ...
      <header className="sticky top-0 z-50 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/90">
        <div className="container flex h-20 items-center">
          ...
          <nav className="ml-8 flex items-center space-x-1">
            <Button variant="ghost" size="sm" className="font-medium text-sm h-9 px-4 rounded-xs bg-primary text-primary-foreground">Radio</Button>
            <Button variant="ghost" size="sm" className="font-medium text-sm h-9 px-4 rounded-xs">Browse</Button>
            <Button variant="ghost" size="sm" className="font-medium text-sm h-9 px-4 rounded-xs">Library</Button>
            <Button variant="ghost" size="sm" className="font-medium text-sm h-9 px-4 rounded-xs">Search</Button>
          </nav>
                  ...
                  <div key={station.stationuuid} className="group cursor-pointer">
                    ...
                    <div className="relative aspect-square bg-gradient-to-br from-blue-500/20 via-purple-500/20 to-pink-500/20 rounded-t-xl mb-4 overflow-hidden">
                      ...
                      <div className="absolute bottom-4 right-4">
                        <Button size="sm" className="rounded-full h-10 w-10 p-0 bg-white/90 hover:bg-white text-black">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {isLoading ? (
                ...
                Array.from({ length: 2 }).map((_, index) => (
                  <div key={index} className="bg-muted/20 rounded-xs  p-6 animate-pulse">
                    <div className="flex items-center gap-4">
                      <div className="w-20 h-20 bg-muted rounded-xs flex-shrink-0" />
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="w-20 h-20 bg-gradient-to-br from-muted via-muted/80 to-muted/60 rounded-lg flex-shrink-0 relative overflow-hidden">
                        ...
                        <div className="absolute bottom-1 right-1">
                          <Button size="sm" className="rounded-full h-6 w-6 p-0 bg-white/90 hover:bg-white text-black">
                ...
                <div className="text-center py-12 col-span-2">
                  <p className="text-muted-foreground">No stations available for recommendations</p>
                </div>
              )}
            </div>
          </div>
                  ...
                  genres.map((genre) => (
                    ...
                    >
                      <div className="relative z-10">
                        ...
                        {genre.description && (
                          <p className="text-xs text-white/95 mt-1 line-clamp-2 font-semibold drop-shadow-sm">
                            {genre.description}
                          </p>
                        )}
                      </div>
